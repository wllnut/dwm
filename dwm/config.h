...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_Return,             spawn,          {.v = dmenucmd } },                                // open app launcher MOD+r
	{ MODKEY|ShiftMask,             XK_Return,             spawn,          {.v = termcmd } },                                 // spawn terminal MOD+return
	{ MODKEY,	                XK_b,                  spawn,          SHCMD("firefox") },
	{ MODKEY|ShiftMask,             XK_s,                  spawn,          SHCMD("flameshot gui") },                          // screenshot MOD+Print
	{ MODKEY,                       XK_e,                  spawn,          SHCMD("exec thunar") },                              // open file manager (nemo) MOD+e
	{ MODKEY,      			XK_l,                  spawn,          SHCMD("exec slock") },                             // lockscreen MOD+ALT+L
